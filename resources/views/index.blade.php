                                        ...
                                        <ul class="nav nav-tabs mb-3" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#pending"
                                                    ...
                                                    <div id="navref1">
                                                    <span class="hidden-xs-down"><i
                                                            class="fas fa-clock"></i><b>&nbsp Pending ( ) </b></span></div></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#approved" role="tab"
                                                    ...
                                                    <div id="navref2"> <span
                                                        class="hidden-xs-down"><i
                                                            class="fas fa-check"></i><b>&nbsp Approved ( 
                                                            ) </b></span></div></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#completed" role="tab"
                                                    aria-selected="false"><span class="hidden-sm-up"></span><div id="navref3"> <span
                                                        class="hidden-xs-down"><i
                                                            class="mdi mdi-check-all"></i><b>&nbsp Completed ( )</b></span></div></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#rejected" role="tab"
                                                    aria-selected="false"><span class="hidden-sm-up"></span><div id="navref4"> <span
                                                        class="hidden-xs-down"><i
                                                            class="mdi mdi-close-circle"></i><b>&nbsp Rejected (  )</b></span></div></a>
                                            </li>
                                        </ul>
                                        <!-------------------------dashboard------------------------------>
                                                                                    ...
                                                                                    <td>
                                                                                        <center>
                                                                                            <button type="button"
                                                                                                ...
                                                                                                data-target="#facultymodal" style="text-decoration:none;">
                                                                                            </button>
                                                                                        </center>
                                                                                    </td>
                                                                                    <td>
                                                                    ...
                                                                    <table id="myTable2" class="table table-bordered table-striped fixed-size-table">
                                                                        ...
                                                                        <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <center>
                                                                                            <button type="button"
                                                                                                class="btn btn-link faculty" id="facultyinfo"
                                                                                                data-toggle="modal" value=""
                                                                                                data-target="#facultymodal" style="text-decoration:none;"></button>
                                                                                        </center>
                                                                                    </td>
                                                                                    <td>
                                                                                        <center>
                                                                                    ...
                                                                                    <td>
                                                                                        <center>
                                                                                           essage = $statusMessages[$status] ?? 'Unknown status';
                                                                                            ?>
                                                                    ...
                                                                    <table id="myTable4" class="table table-bordered table-striped fixed-size-table">
                                                                        ...
                                                                        <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <center>
                                                                                            <button type="button" value="" class="btn btn-danger btnrejfeed" data-toggle="modal"
